...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <style>
    ...
    .error-box {
        ...
        max-width: 300px;
        padding: 15px;
        background-color: white; /* Màu nền đỏ nhạt */
        color: black; /* Màu chữ đỏ */
        border: 1px solid black; /* Viền đỏ nhạt */
        border-radius: 5px;
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
        animation: fadeOut 5s ease-in-out;
        animation-fill-mode: forwards; /* Sau khi ẩn, giữ trạng thái cuối */
    }
...
<body>
  ...
  <script>
        // Script điều khiển spinner
        document.addEventListener("DOMContentLoaded", function () {
            // Ẩn spinner khi trang đã tải
    ...
    // Hiển thị spinner khi chuyển trang
        ...
        document.addEventListener("DOMContentLoaded", function () {
          const spinner = document.getElementById("loading-spinner");
          spinner.style.display = "none"; // Ẩn spinner khi trang tải hoàn tất
});
