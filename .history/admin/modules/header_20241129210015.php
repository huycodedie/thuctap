...
if (isset($_SESSION['errors'])) {
    ...
    foreach ($_SESSION['errors'] as $errors) {
        echo '<p > <img src="assets/img/vdong.gif" alt="Icon động" width="50" height="50">' . htmlspecialchars($errors) . '</p>';
    }
    echo '</div>';
  ...
  foreach ($_SESSION['error'] as $error) {
    echo '<p > <img src="assets/img/vdong.gif" alt="Icon động" width="50" height="50">' . htmlspecialchars($error) . '</p>';
  }
  echo '</div>';
