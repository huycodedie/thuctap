                        ...
                        <table class="table table-broderless datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-1 text-center">Mã sv</th>
                            ...
                            <body>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" scope="row"> <?php echo $row['idsv'] ?> </th>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <input name="thilai" type="checkbox" class="form-check-input" title="Cấp quyền sửa điểm" onchange="this.form.submit();"  <?php echo ($row['thilai'] == 1) ? 'checked' : ''; ?>>
                                        </form>
...
<h1>Chưa có học sinh nào đăng ký lớp học phần</h1>
