                            ...
                            <body>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="modules/trungchuyen/quanlydanhmuctruyen/lophanhchinh/xulylhc.php?idlhc=<?php echo $row['idlhc'] ?>&makhoa" class="btn btn-danger btn-sm" title="xóa lớp hành chính"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
