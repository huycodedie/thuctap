                            ...
                            <body>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="index.php?action=phutrach&idlhc=<?php echo $row['idlhc'] ?>&idkhoa=<?php echo $row['idlhc'] ?>" class="btn btn-success btn-sm" title="thêm người phụ trách"><i class="bi bi-person"></i></a>
