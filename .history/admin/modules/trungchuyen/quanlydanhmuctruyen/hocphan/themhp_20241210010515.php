                ...
                <div class="card-body mt-4">
                    <form asp-action="Create" method="POST" action="modules/trungchuyen/quanlydanhmuctruyen/hocphan/xulyhp.php" >           
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input asp-for="CreatedBy" type="text" placeholder="nhập tên" class="form-control"  name="tenhp" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Số tín chỉ</label>
                                <div class="col-sm-5">
                                    <input asp-for="CreatedBy" type="text" placeholder="nhập tên" class="form-control"  name="tinchi" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Khoa</label>
                                ...
                                <select name="makhoa" id="search" asp-for="CreatedBy" type="text" class="form-control" ><option value="0" >Chọn khoa</option>
                                <?php 
                                $i = 0;
