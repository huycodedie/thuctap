...
if(isset($_POST['themkhoa'])){
    $checkten = "SELECT * FROM qlkhoa WHERE tenkhoa = '$tenkhoa'";
    $result = mysqli_query($mysqli,$checkten);
    ...
    }   làm sao để khi check không phân biệt chữ hoa chữ thường
    ...
    if ($row[0] > 0) {
        ...
        if (!mysqli_query($mysqli, $sql_view)) {         
