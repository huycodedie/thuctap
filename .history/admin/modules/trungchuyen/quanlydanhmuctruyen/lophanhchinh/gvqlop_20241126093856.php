                        ...
                        ?>    
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10" >
                                    ...
                                    <input style="display: none;" asp-for="CreatedBy" type="text" value="<?php $row['makhoa'] ?> - <?php echo $row['tenkhoa'] ?> " class="form-control" name="makhoa" readonly>
                                </div>
                            </div>  
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input style="display: none;" asp-for="CreatedBy" type="text" value="<?php echo $row['idlhc'] ?> - <?php echo $row['tenlop'] ?> " class="form-control" name="tenlop" readonly>
                                </div>
                            </div>
                        <?php } ?>
