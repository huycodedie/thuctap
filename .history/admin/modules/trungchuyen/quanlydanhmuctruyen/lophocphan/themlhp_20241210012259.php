                ...
                <div class="card-body mt-4">
                    ...
                    <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Mã học phần</label>
                                ...
                                <select name="mahp" id="mahp" asp-for="CreatedBy" type="text" class="form-control" ><option value="0" >chọn học phần</option>
                                <?php 
                                $i = 0;
                            ...
                            <label class="col-sm-2 col-form-label">giáo viên phụ trách</label>
                                ...
                                <select name="magv" id="idgv" asp-for="CreatedBy" type="text" class="form-control " ><option value="0" >chọn giáo viên</option>
                                <?php 
                                $i = 0;
