...
if(isset($_POST['themlhp'])){
    ...
    $checkmaQuery = "SELECT * FROM viewusergv_lhp WHERE malhp = '$malhp'";
    $result_check = mysqli_query($mysqli, $checkkhoaQuery);
    $checkkhoaQuery = "SELECT * FROM viewusergv_lhp WHERE malhp = '$malhp'";
    $result_check = mysqli_query($mysqli, $checkkhoaQuery);
    if (mysqli_num_rows($result) > 0) {
