...
<?php          
    ...
    <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.php?action=khoa&idgv=<?php echo $_GET['idgv'] ?>">Home</a></li>
      ...
      <li class="breadcrumb-item"><a href="index.php?action=diem-sinh-vien&idgv=<?php echo $_GET['idgv'] ?>&idlhc=<?php echo $row['malhc'] ?>">danh sách</a></li>
    </nav>
</div>
<?php } ?>
