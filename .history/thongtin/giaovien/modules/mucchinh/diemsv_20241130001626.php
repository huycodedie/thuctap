...
<?php          
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="index.php?action=danh-sach-sv&idgv=<?php echo $_GET['idgv'] ?>&idlhc=<?php echo $row['idlhc'] ?>">danh sách</a></li>
      <li class="breadcrumb-item"><a href="index.php?action=diem-sinh-vien&idsv=<?php echo $_GET['idsv'] ?>">danh sách</a></li>
    </nav>
</div>
<?php } ?>
