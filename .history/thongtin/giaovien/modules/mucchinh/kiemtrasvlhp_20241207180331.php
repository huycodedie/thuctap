...
<section class="section">
        ...
        <div class="col-lg-3">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Default Table -->
              <li class="nav-item">
    <a class="nav-link collapsed" class="load-content" href="#" data-action="sv-lop-hoc-phan" >
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" aria-colindex="load-content" href="#" data-action="doi" >
