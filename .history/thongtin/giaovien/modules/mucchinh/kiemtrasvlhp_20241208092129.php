...
<section class="section">
      <div class="row">
        <div class="col-lg-3">
         ...
         <form action="index.php?action=timkiem&id=<?php echo $user_id ?>&malhp=<?php echo $_GET['malhp'] ?>" method="POST">
                <input class="search" id="search_input" placeholder="Bạn muốn tìm truyện gì" name="tukhoa">
                <button>
