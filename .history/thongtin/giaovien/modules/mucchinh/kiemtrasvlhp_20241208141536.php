...
<section class="section">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="index.php?action=timkiem&idgv=<?php echo $user_id ?>&malhp=<?php echo $_GET['malhp'] ?>" method="POST">
                <input class="search" value="<?php echo $tukhoa  ?>" placeholder="Nhập MSV & Tên SV" name="tukhoa">
                <button>
                    <i class="fa fa-search" aria-hidden="true" name="timkiem">tìm kiếm</i>
                </button>
      ...
      <form class="search-form d-flex align-items-center" method="POST" action="index.php?action=timkiem&idgv=<?php echo $user_id ?>&malhp=<?php echo $_GET['malhp'] ?>">
        <input value="<?php echo $tukhoa  ?>" placeholder="Nhập MSV & Tên SV" name="tukhoa" placeholder="Search" title="Enter search keyword">
