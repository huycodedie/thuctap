...
<main id="main" class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="index.php?action=sv-lop-hoc-phan&mag=<?php echo $user_id ?>&malhp=<?php echo $_GET['malhp'] ?>">Sinh viên</a></li>
    </nav>
</div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Chọn file
                              <form action="modules/mucchinh/xuly.php?idgv=<?php echo $_GET['idgv'] ?>&malhp=<?php echo $_GET['malhp'] ?>" method="post" enctype="multipart/form-data">
                              <div class="mb-3">
