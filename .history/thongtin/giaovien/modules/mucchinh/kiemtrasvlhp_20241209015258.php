            ...
            <div class="card-body">
              ...
              <div class="search-bar">
                ...
                <div class="modal fade" id="verticalycentered" tabindex="-1">
                      ...
                      <button type="button" class="btn  btn-primary " ><a>xuất dữ liệu ra Excel</a></button>
                      <button type="button" class="btn  btn-primary "><a href="upload.php?action=export">xuất dữ liệu ra Excel</a></button>
              </div>
            </div>
          </div>
        </div>
