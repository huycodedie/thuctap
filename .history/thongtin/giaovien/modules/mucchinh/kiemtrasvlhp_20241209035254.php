            ...
            <div class="card-body">
              ...
              <div class="search-bar">
                ...
                <div class="modal fade" id="verticalycentered" tabindex="-1">
                      ...
                      <h1></h1>
                      <button type="button" class="btn  btn-primary "><a href="modules/mucchinh/xulyxuatexecl.php?action=export?malhp= " style="color:aliceblue">xuất data ra Excel</a></button>
              </div>
            </div>
          </div>
        </div>
