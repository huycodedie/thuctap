    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <?php $query_check = "SELECT COUNT(*) AS count FROM bangdiem b JOIN usersv s ON s.idsv = b.masv WHERE diemthilai > 0 AND (s.usernamesv LIKE '%".$tukhoa."%' OR b.masv LIKE '%".$tukhoa."%')";
