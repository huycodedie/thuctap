...
$sql_danhsach2 = "SELECT*FROM usergv g
                ...
                left JOIN qllophocphan p ON p.malhp = b.malhp
                left JOIN usersv s ON s.idsv = b.masv
                WHERE b.idgv = '$_GET[idgv]'AND b.malhp = '$_GET[malhp]'"; 
...
<?php          
    ...
    <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.php?action=lop-hoc-phan&idgv=<?php echo $_GET['idgv'] ?>">khoa</a></li>
      <li class="breadcrumb-item"><a href="index.php?action=sv-lop-hoc-phan&idgv=<?php echo $_GET['idgv'] ?>&malhp=<?php echo $_GET['malhp'] ?>">Sinh viên</a></li>
    </nav>
</div>
<?php } ?>
