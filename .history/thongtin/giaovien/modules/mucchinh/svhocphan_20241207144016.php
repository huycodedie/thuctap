...
<div class="card">
  <div class="card-body">
    ...
    <table class="table table-striped">
      <thead>
        <tr>
          <th scope="col-1 text-center">STT</th>
          <th scope="col text-center">Mã Sinh viên</th>
          <th scope="col text-center">Tên sinh viên</th>
          <th scope="col text-center">Quá trình</th>
          <th scope="col text-center">Cuối kỳ</th>
