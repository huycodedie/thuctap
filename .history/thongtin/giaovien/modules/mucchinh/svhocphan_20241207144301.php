    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <th scope="col-1 text-center ">Quá trình</th>
      ...
      <tbody>
        ...
        <?php 
            ...
            ?>
            <tr>
            <th class="" scope="row"><?php echo $i ?> </th>
            <td class=""><?php echo $row['masv'] ?></td>
            <td class=""><?php echo $row['usernamesv'] ?></td>
            <th class="" scope="row"> <?php echo $row['quatrinh'] ?> </th>  
