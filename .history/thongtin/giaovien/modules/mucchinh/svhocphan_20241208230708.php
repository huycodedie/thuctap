    ...
    <table class="table table-striped">
      ...
      <body>
        ...
        <?php 
            ...
            if($sua < 1){
            ?> 
            <a href="index.php?action=them-diem-sinh-vien&malhp=<?php $row['malhp'] ?>&masv=<?php echo $row['masv'] ?>" class="btn btn-primary btn-sm" title="sua noi dung"><i class="bi bi-file-earmark-text me-1"></i></a>
            <?php }else{ ?>
