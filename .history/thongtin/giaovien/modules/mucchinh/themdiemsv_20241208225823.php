...
<main id="main" class="main">
    <form method="POST" action="modules/mucchinh/xuly.php?madiem=<?php $row = mysqli_fetch_array($query_themdiem2); if($row){echo $row['madiem'];} ?>&malhp=<?php echo $_GET['malhp'] ?>&masv=<?php echo $_GET['masv'] ?>&user_id = " enctype="multipart/form-data">
    <div class="row pb-2">
