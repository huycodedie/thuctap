...
<main id="main" class="main">
    <form method="POST" action="modules/mucchinh/xuly.php?madiem=<?php $row = mysqli_fetch_array($query_themdiem2); if($row){echo $row['madiem'];} ?>&malhp=<?php echo $_GET['malhp'] ?>&masv=<?php echo $_GET['masv'] ?>&magv =<?php $row = mysqli_fetch_array($query_themdiem1); if($row){echo $row['magv'];} ?>" enctype="multipart/form-data">
    <div class="row pb-2">
