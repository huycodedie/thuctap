...
<main id="main" class="main">
    <form method="POST" action="modules/mucchinh/xuly.php?madiem=<?php $row = mysqli_fetch_array($query_themdiem2); if($row){ $row['madiem'];} ?>&malhp=<?php $_GET['malhp'] ?>&masv=<?php $_GET['masv'] ?>&magv=<?php $row = mysqli_fetch_array($query_themdiem1); if($row){ $row['idgv'];} ?>" enctype="multipart/form-data">
    <div class="row pb-2">
