...
if(isset($_POST['gvthemdiem'])){
    ...
    header("Location:../../index.php?action=sv-lop-hoc-phan&malhp=$malhp&idgv=$");


    exit();
}if(isset($_POST['themexcel'])){
    ...
    header("Location:../../index.php?action=sv-lop-hoc-phan&malhp=$malhp&idgv=$user_id");
}
