...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 20, 2024 lúc 06:04 PM
...
CREATE TABLE `bangdiem` (
  ...
  `diemthilai` int(11) DEFAULT NULL,
  `sua` int(11) NOT NULL,
...
(53, 10013, 10017, 60, 10000001, 8, 8, NULL, 0, 0, '2024-12-02 22:12:39', '2024-12-02 15:12:41'),
(56, 10013, 10017, 60, 10000002, NULL, NULL, NULL, 0, 0, '2024-12-02 22:13:51', '2024-12-02 15:13:56'),
(60, 10014, 10027, 1, 10000001, NULL, NULL, NULL, 0, 0, '2024-12-02 22:17:16', '2024-12-02 15:17:17'),
(62, 10013, 10017, 60, 10000003, NULL, NULL, NULL, 0, 0, '2024-12-02 22:18:14', '2024-12-02 15:18:17'),
(63, 10014, 10027, 1, 10000002, NULL, NULL, NULL, 0, 0, '2024-12-02 22:18:21', '2024-12-02 15:18:23'),
(64, 10014, 10027, 1, 10000003, NULL, NULL, NULL, 0, 0, '2024-12-02 22:18:25', '2024-12-02 15:18:28'),
(65, 10014, 10027, 1, 10000004, NULL, NULL, NULL, 0, 0, '2024-12-02 22:18:30', '2024-12-02 15:18:33'),
(66, 10014, 10027, 1, 10000005, 8, 8, NULL, 0, 0, '2024-12-02 22:18:35', '2024-12-02 15:18:39'),
(67, 10012, 10016, 1, 10000001, NULL, NULL, NULL, 0, 0, '2024-12-09 22:49:20', '2024-12-09 15:49:22'),
(68, 10012, 10016, 1, 10000002, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:24', '2024-12-09 15:53:27'),
(69, 10012, 10016, 1, 10000003, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:38', '2024-12-09 15:53:41'),
(70, 10012, 10016, 1, 10000004, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:44', '2024-12-09 15:53:46'),
(71, 10012, 10016, 1, 10000006, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:49', '2024-12-09 15:53:52'),
(72, 10012, 10016, 1, 10000007, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:55', '2024-12-09 15:53:58'),
(73, 10012, 10016, 1, 10000008, NULL, NULL, NULL, 0, 0, '2024-12-09 22:53:59', '2024-12-09 15:54:04'),
(78, 10012, 10016, 1, 10000005, 5, 5, NULL, 0, 0, '2024-12-09 23:09:39', '2024-12-09 16:09:41'),
(79, 10012, 10040, 1, 10000001, NULL, NULL, NULL, 0, 0, '2024-12-10 01:46:44', '2024-12-09 18:46:46'),
(80, 10012, 10040, 1, 10000005, 9, 9, NULL, 0, 0, '2024-12-10 01:51:50', '2024-12-09 18:51:53');
...
INSERT INTO `namhoc` (`idnam`, `nam_hoc`, `time`) VALUES
(1, '2024-2025_HK_1', '2024-12-20 08:53:30'),
(2, '2024-2025_HK_2.1', '2024-12-20 08:55:39'),
(3, '2024-2025_HK_2.2', '2024-12-20 08:55:39');
...
INSERT INTO `qllophocphan` (`malhp`, `tenlhp`, `hoc_ky`, `mahp`) VALUES
(10016, 'mã nguồn mở_LT_01', 1, 10012),
(10017, 'Kinh tế vĩ mô LT_01', 1, 10013),
(10027, 'Thị giác máy tính LT_01', 1, 10014),
(10028, 'Thị giác máy tính LT_02', 1, 10014),
(10040, 'mã nguồn mở_LT_02', 2, 10012);
...
(33, 1, 10028, '2024-11-28 13:12:07'),
(46, 1, 10040, '2024-12-09 16:10:30'),
(47, 1, 10017, '2024-12-09 18:51:44');
...
--
ALTER TABLE `bangdiem`
  MODIFY `madiem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT cho bảng `namhoc`
--
ALTER TABLE `namhoc`
  MODIFY `idnam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `qlhocphan`
--
ALTER TABLE `qlhocphan`
  MODIFY `mahp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10045;

--
-- AUTO_INCREMENT cho bảng `qlkhoa`
--
ALTER TABLE `qlkhoa`
  MODIFY `idkhoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10018;

--
-- AUTO_INCREMENT cho bảng `qllophanhchinh`
--
ALTER TABLE `qllophanhchinh`
  MODIFY `idlhc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT cho bảng `qllophocphan`
--
ALTER TABLE `qllophocphan`
  MODIFY `malhp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10043;

--
-- AUTO_INCREMENT cho bảng `usergv`
--
ALTER TABLE `usergv`
  MODIFY `idgv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `usersv`
  MODIFY `idsv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000014;
...
--
ALTER TABLE `viewusergv_lhp`
  MODIFY `maview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
ALTER TABLE `qllophocphan`
  ...
  ADD CONSTRAINT `qllophocphan_ibfk_2` FOREIGN KEY (`hoc_ky`) REFERENCES `namhoc` (`idnam`);
