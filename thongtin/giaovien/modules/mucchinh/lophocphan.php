                            ...
                            <body>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="index.php?action=sv-lop-hoc-phan&magv=<?php echo $row['idgv'] ?>&malhp=<?php echo $row['malhp'] ?>" class="btn btn-primary btn-sm" title="noi dung"><i class="bi bi-file-earmark-text me-1"></i></a>
