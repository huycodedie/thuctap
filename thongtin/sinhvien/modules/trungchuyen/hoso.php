    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <h2><?php echo $row['usernamesv'] ?></h2>
          <h3><?php echo $row['congviec'] ?></h3>
          <!--
        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <p class="small fst-italic"><?php echo $row['gioithieu'] ?></p>

              <h5 class="card-title">Hồ sơ</h5>
              <div class="row">
                <div class="col-lg-3 col-md-4 label ">Mã sinh viên</div>
                <div class="col-lg-9 col-md-8"><?php echo $row['idsv'] ?></div>
              </div>
              <div class="row">
                <div class="col-lg-3 col-md-4 label ">Họ tên</div>
                <div class="col-lg-9 col-md-8"><?php echo $row['usernamesv'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Phân quyên</div>
                <div class="col-lg-9 col-md-8"><?php echo $row['congviec'] ?></div>
             
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Quốc gia</div>
                <div class="col-lg-9 col-md-8"><?php echo $row['quoctich'] ?></div>
              </div>
